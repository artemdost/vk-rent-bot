...
REQUEST_TIMEOUT = 30
DEFAULT_SCHEDULE_DELAY = 2 * 24 * 60 * 60  # 2 дня запаса
...
def send_to_scheduled(text: str, attachments: Optional[str] = None, delay_seconds: int = DEFAULT_SCHEDULE_DELAY) -> Dict[str, Any]:
    """
